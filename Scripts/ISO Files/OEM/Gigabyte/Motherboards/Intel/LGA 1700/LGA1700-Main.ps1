...
Write-Host '                                                                                    ' -BackgroundColor White
Write-Host '          - Gigabyte: Intel LGA1700 AORUS motherboards                              ' -ForegroundColor DarkBlue -BackgroundColor White
Write-Host '          - Gigabyte: Intel LGA1700 Gaming motherboards                             ' -ForegroundColor DarkBlue -BackgroundColor White
Write-Host '          - Gigabyte: Intel LGA1700 UD - Ultra Durable motherboards                 ' -ForegroundColor DarkBlue -BackgroundColor White
Write-Host '          - Gigabyte: Intel LGA1700 AERO motherboards                               ' -ForegroundColor DarkBlue -BackgroundColor White
Write-Host '          - Gigabyte: ALL Intel LGA1700 motherboards                                ' -ForegroundColor DarkBlue -BackgroundColor White
Write-Host '                                                                                    ' -BackgroundColor White
pause
Clear-Host

Write-Host "======= $Title ======"
Write-Host " 1. OSDCloud: Create ISO - Gigabyte Intel LGA 1700 AORUS motherboards"
Write-Host " 2. OSDCloud: Create ISO - Gigabyte Intel LGA 1700 Gaming motherboards"
Write-Host " 3. OSDCloud: Create ISO - Gigabyte Intel LGA 1700 UD - Ultra Durable motherboards"
Write-Host " 4. OSDCloud: Create ISO - Gigabyte Intel LGA 1700 AERO motherboards"
Write-Host " 5. OSDCloud: Create ISO - Gigabyte Intel LGA 1700 Eagle motherboards"
Write-Host " 6. OSDCloud: Create ISO - ALL Gigabyte Intel LGA 1700 motherboards"
