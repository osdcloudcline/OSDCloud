...
Write-Host '          - Gigabyte: Intel LGA 1700/LGA 1851 socket types                    ' -ForegroundColor DarkBlue -BackgroundColor White
Write-Host '                                                                              ' -BackgroundColor White
pause
Clear-Host
...
do 
{
  ...
  {
'1'{cls
    $LGA1851 = Invoke-WebRequest("https://raw.githubusercontent.com/osdcloudcline/OSDCloud/refs/heads/main/Scripts/ISO%20Files/OEM/Gigabyte/Motherboards/Intel/LGA%201851/LGA1851-Main.ps1")
    Invoke-Expression $($LGA1851.Content)
    }
'2'{cls
    $LGA1700 = Invoke-WebRequest("https://raw.githubusercontent.com/osdcloudcline/OSDCloud/refs/heads/main/Scripts/ISO%20Files/OEM/Gigabyte/Motherboards/Intel/LGA%201700/LGA1700-Main.ps1")
