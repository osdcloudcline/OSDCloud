...
Write-Host
Write-Verbose "Creating New OSDCloud WinRE Template specific for ALL Gigabyte Eagle LGA 1851 motherboards to enable wireless networking support..." -Verbose
