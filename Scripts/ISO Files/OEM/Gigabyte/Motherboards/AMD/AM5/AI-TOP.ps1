...
Write-Host
Write-Verbose "Processing: Gigabyte AM5 AI TOP Motherboard drivers, Virtualization drivers, scripting support and other utilities file downloads" -Verbose
Write-Host
...
New-OSDCloudTemplate -Name ASUS-AITOP-AM5 -WinRE
