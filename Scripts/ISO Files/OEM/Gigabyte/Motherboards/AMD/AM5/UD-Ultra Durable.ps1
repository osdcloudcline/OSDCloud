...
Write-Host
Write-Verbose "Processing: Gigabyte AMD AM5 Ultra Durable motherboard driver downloads" -Verbose
Write-Host  
...
Write-Host
Write-Verbose "Completed: Gigabyte AMD AM5 Ultra Durable motherboard driver downloads" -Verbose
Write-Host 
...
Write-Host
Write-Verbose "Creating New OSDCloud WinRE Template specific for ALL Gigabyte AM5 Ultra Durable motherboards to enable wireless networking support..." -Verbose
