...
Write-Host
Write-Verbose "Processing: Gigabyte AM5 UD - Ultra Durable Motherboard drivers, Virtualization drivers, scripting support and other utilities file downloads" -Verbose
Write-Host
...
Write-Host
Write-Verbose "Completed: ALL Gigabyte AM5 UD - Ultra Durable Motherboard driver, Virtualization driver, scripting support and other utilities file downloads" -Verbose
Write-Host
