...
Write-Host
Write-Verbose "Processing: Gigabyte AMD AM5 Gaming motherboard driver downloads" -Verbose
Write-Host  
...
Write-Host
Write-Verbose "Completed: Gigabyte AMD AM5 Gaming motherboard driver downloads" -Verbose
Write-Host
