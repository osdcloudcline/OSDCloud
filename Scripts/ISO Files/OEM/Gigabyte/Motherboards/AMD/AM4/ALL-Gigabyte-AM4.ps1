...
Write-Host
Write-Verbose "Processing: Gigabyte AM4 Motherboard driver, Virtualization driver, scripting support and other utilities file downloads" -Verbose
Write-Host 
...
Write-Host
Write-Verbose "Creating New OSDCloud WinRE Template specific for Gigabyte AM4 motherboards to enable wireless networking support..." -Verbose
