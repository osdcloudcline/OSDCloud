...
Write-Host
Write-Verbose "Processing: Gigabyte AM4 Ultra Durable Motherboard driver downloads" -Verbose
Write-Host 
...
Write-Host
Write-Verbose "Completed: Gigabyte AM4 Ultra Durable Motherboard driver downloads" -Verbose
Write-Host
...
Write-Host
Write-Verbose "Creating New OSDCloud WinRE Template specific for ALL Gigabyte Ultra Durable AM4 motherboards to enable wireless networking support..." -Verbose
