...
Write-Host
Write-Verbose "Processing: Gigabyte AM4 Gaming Motherboard driver downloads" -Verbose
Write-Host 
...
Write-Host
Write-Verbose "Completed: Gigabyte AM4 Gaming Motherboard driver downloads" -Verbose
Write-Host
