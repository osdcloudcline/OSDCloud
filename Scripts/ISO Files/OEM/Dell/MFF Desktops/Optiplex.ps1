...
Write-Host '     - Networking and Storage: Dell Optiplex Micro Form Factor desktop drivers                ' -ForegroundColor DarkBlue -BackgroundColor White
...
$Optiplex = Invoke-WebRequest("")
Invoke-Expression $($Optiplex.Content)
...
Write-Host
Write-Verbose "Creating New OSDCloud WinRE Template specific for ALL DELL Optiplex Micro-Form Factor computers to enable wireless networking support..." -Verbose
New-OSDCloudTemplate -Name DELL-OptiplexMFF -WinRE
