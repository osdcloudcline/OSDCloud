...
Write-Host
Write-Verbose "Processing: ASRock AMD AM5 motherboard driver downloads" -Verbose
Write-Host 
...
Write-Host
Write-Verbose "Completed: ASRock AMD AM5 motherboard driver downloads" -Verbose
Write-Host 
...
New-OSDCloudTemplate -Name ASRock-AM5 -WinRE
...
$WorkspacePath = "C:\OSDCloud\ALL-ASRock-AM5"
...
$OSDCloudISOPath = "C:\OSDCloud\ALL-ASRock-AM5"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ALL-ASRock-AM5\OSDCloud-ALL-ASRock-AM5.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ALL-ASRock-AM5\OSDCloud-ALL-ASRock-AM5_NoPrompt.iso" -Force
