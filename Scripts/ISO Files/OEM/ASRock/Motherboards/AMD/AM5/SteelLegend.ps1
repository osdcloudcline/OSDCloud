...
Write-Host
Write-Verbose "Processing: ASRock AMD AM5 Steel Legend motherboard driver downloads" -Verbose
Write-Host
...
Write-Host
Write-Verbose "Completed: ASRock AMD Steel Legend AM5 motherboard driver downloads" -Verbose
Write-Host 
...
$WorkspacePath = "C:\OSDCloud\ASRock-SteelLegendMotherboards-AM5"
...
$OSDCloudISOPath = "C:\OSDCloud\ASRock-SteelLegendMotherboards-AM5"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ASRock-SteelLegendMotherboardsk-AM5\OSDCloud-ASRock-SteelLegendMotherboards-AM5.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ASRock-SteelLegendMotherboardsk-AM5\OSDCloud-ASRock-SteelLegendMotherboards-AM5_NoPrompt.iso" -Force
