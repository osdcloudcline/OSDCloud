...
Write-Host
Write-Verbose "Processing: ASRock AM4 Phantom Gaming Motherboard driver, Virtualization driver, scripting support and other utilities file downloads" -Verbose
Write-Host 
