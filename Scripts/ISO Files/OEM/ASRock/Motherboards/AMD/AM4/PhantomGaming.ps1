...
Write-Host
Write-Verbose "Completed: ASRock AM4 Phantom Gaming Motherboard driver downloads" -Verbose
Write-Host
...
Write-Host
Write-Verbose "Completed: ALL ASRock AM4 Phantom Gaming Motherboard driver, Virtualization driver, scripting support and other utilities file downloads" -Verbose
Write-Host
...
Write-Host
Write-Verbose "Creating New OSDCloud WinRE Template specific for ASRock AM4 Phantom Gaming motherboards to enable wireless networking support..." -Verbose
New-OSDCloudTemplate -Name ASRock-PhantomGaming-AM4 -WinRE
...
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ASRock-PhantomGamingMotherboards-AM4\OSDCloud-PhantomGamingMotherboards-AM4.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ASRock-PhantomGamingMotherboards-AM4\OSDCloud-PhantomGamingMotherboards-AM4_NoPrompt.iso" -Force
