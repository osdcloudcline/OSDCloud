...
Write-Host
Write-Verbose "Processing: ASRock AM4 Taichi Motherboard driver downloads" -Verbose
Write-Host
...
Write-Host
Write-Verbose "Completed: ASRock AM4 Taichi Motherboard driver downloads" -Verbose
Write-Host
...
Write-Host
Write-Verbose "Completed: ALL ASRock AM4 Taichi Motherboard driver, Virtualization driver, scripting support and other utilities file downloads" -Verbose
Write-Host
...
Write-Host
Write-Verbose "Creating New OSDCloud WinRE Template specific for ASRock AM4 Taichi motherboards to enable wireless networking support..." -Verbose
New-OSDCloudTemplate -Name ASRock-Taichi-AM4 -WinRE
...
$WorkspacePath = "C:\OSDCloud\ASRock-TaichiMotherboards-AM4"
...
$OSDCloudISOPath = "C:\OSDCloud\ASRock-TaichiMotherboards-AM4"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ASRock-TaichiMotherboards-AM4\OSDCloud-TaichiMotherboards-AM4.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ASRock-TaichiMotherboards-AM4\OSDCloud-TaichiMotherboards-AM4_NoPrompt.iso" -Force
