...
Write-Host
Write-Verbose "Processing: ASRock AM4 Steel Legend Motherboard driver downloads" -Verbose
Write-Host
...
Write-Host
Write-Verbose "Completed: ASRock AM4 Steel Legend Motherboard driver downloads" -Verbose
Write-Host
...
Write-Host
Write-Verbose "Completed: ALL ASRock AM4 Steel Legend Motherboard driver, Virtualization driver, scripting support and other utilities file downloads" -Verbose
Write-Host
...
$OSDCloudISOPath = "C:\OSDCloud\ASRock-SteelLegendMotherboards-AM4"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ASRock-SteelLegendMotherboards-AM4\OSDCloud-SteelLegendMotherboards-AM4.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ASRock-SteelLegendMotherboards-AM4\OSDCloud-SteelLegendMotherboards-AM4_NoPrompt.iso" -Force
