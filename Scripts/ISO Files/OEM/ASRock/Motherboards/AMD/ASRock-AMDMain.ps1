...
do 
{
  ...
  {
'1'{cls
    $AM4 = Invoke-WebRequest("https://raw.githubusercontent.com/osdcloudcline/OSDCloud/refs/heads/main/Scripts/ISO%20Files/OEM/ASRock/Motherboards/AMD/AM4/AM4-Main.ps1")
    Invoke-Expression $($AM4.Content)
    }
'2'{cls
    $AM5 = Invoke-WebRequest("https://raw.githubusercontent.com/osdcloudcline/OSDCloud/refs/heads/main/Scripts/ISO%20Files/OEM/ASRock/Motherboards/AMD/AM5/AM5-Main.ps1")
