...
New-OSDCloudTemplate -Name ASRock-PRO-LGA1851 -WinRE
...
$WorkspacePath = "C:\OSDCloud\ASRock-PROMotherboards-LGA1851"
...
$OSDCloudISOPath = "C:\OSDCloud\ASRock-PROMotherboards-LGA1851"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ASRock-PROMotherboards-LGA1851\OSDCloud-ASRock-PROMotherboards-LGA1851.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ASRock-PROMotherboards-LGA1851\OSDCloud-ASRock-PROMotherboards-LGA1851_NoPrompt.iso" -Force
