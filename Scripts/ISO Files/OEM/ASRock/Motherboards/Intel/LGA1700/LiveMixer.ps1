...
$OSDCloudISOPath = "C:\OSDCloud\ASRock-LiveMixerMotherboards-LGA1700"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ASRock-LiveMixerMotherboards-LGA1700\OSDCloud-ASRock-LiveMixerMotherboards-LGA1700.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ASRock-LiveMixerMotherboards-LGA1700\OSDCloud-ASRock-LiveMixerMotherboards-LGA1700_NoPrompt.iso" -Force
