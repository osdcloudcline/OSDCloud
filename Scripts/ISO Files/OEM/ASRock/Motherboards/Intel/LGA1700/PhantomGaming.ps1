...
$WorkspacePath = "C:\OSDCloud\ASRock-PhantomGamingMotherboards-LGA1700"
...
$OSDCloudISOPath = "C:\OSDCloud\ASRock-PhantomGamingMotherboards-LGA1700"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ASRock-PhantomGamingMotherboards-LGA1700\OSDCloud-ASRock-PhantomGamingMotherboards-LGA1700.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ASRock-PhantomGamingMotherboards-LGA1700\OSDCloud-ASRock-PhantomGamingMotherboards-LGA1700_NoPrompt.iso" -Force
