...
Function Show-MainMenu{
   [CmdletBinding()]
   param(
   [string]$Title = 'OSD Cloud - ISO Creation ASUS Intel LGA 1851 Main Menu',
...
Write-Host "======= $Title ======"
Write-Host " 1. OSDCloud: ASUS ALL Intel LGA 1851 motherboards"
Write-Host " 2. OSDCloud: ASUS Intel LGA 1851 Business motherboards"
Write-Host " 3. OSDCloud: ASUS Intel LGA 1851 CSM motherboards"
Write-Host " 4. OSDCloud: ASUS Intel LGA 1851 Other motherboards"
Write-Host " 5. OSDCloud: ASUS Intel LGA 1851 PRIME motherboards"
Write-Host " 6. OSDCloud: ASUS Intel LGA 1851 ProArt motherboards"
Write-Host " 7. OSDCloud: ASUS Intel LGA 1851 ROG motherboards"
Write-Host " 8. OSDCloud: ASUS Intel LGA 1851 TUF Gaming motherboards"
