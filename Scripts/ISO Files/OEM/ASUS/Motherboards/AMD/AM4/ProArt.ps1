...
Write-Host
Write-Verbose "Processing: ASUS AM4 ProArt motherboard driver downloads" -Verbose
Write-Host 
...
Write-Host
Write-Verbose "Completed: ASUS AM4 ProArt motherboard driver downloads" -Verbose
Write-Host 
