...
Write-Host
Write-Verbose "Processing: ASUS AM4 ROG - Republic of Gamers motherboard driver downloads" -Verbose
Write-Host 
...
Write-Host
Write-Verbose "Completed: ASUS AM4 ROG - Republic of Gamers motherboard driver downloads" -Verbose
Write-Host 
...
Write-Host
Write-Verbose "Completed: ALL ASUS AM4 ROG - Republic of Gamers Motherboard driver, Virtualization driver, scripting support and other utilities file downloads" -Verbose
Write-Host
