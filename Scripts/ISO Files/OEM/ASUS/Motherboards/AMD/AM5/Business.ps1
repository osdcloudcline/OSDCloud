...
Write-Host
Write-Verbose "Processing: ASUS AMD AM5 Business motherboard driver downloads" -Verbose
Write-Host  
...
Write-Host
Write-Verbose "Completed: ASUS AMD AM5 Business motherboard driver downloads" -Verbose
Write-Host 
