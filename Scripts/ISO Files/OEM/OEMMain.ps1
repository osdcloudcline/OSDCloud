...
Write-Host '     - Lenovo: Laptops                                                        ' -ForegroundColor DarkBlue -BackgroundColor White
Write-Host '     - Microsoft: Surface Tablets                                             ' -ForegroundColor DarkBlue -BackgroundColor White
Write-Host '                                                                              ' -BackgroundColor White
pause
Clear-Host
...
'2'{cls
    $OEMDesktops = Invoke-WebRequest("https://github.com/osdcloudcline/OSDCloud/raw/refs/heads/main/Scripts/ISO%20Files/Desktop%20Motherboards/DesktopMotherboardsMain.ps1")
