...
Write-Host
Write-Verbose "Completed: ALL MSI LGA 1851 Motherboard driver, Virtualization driver, scripting support and other utilities file downloads" -Verbose
Write-Host
...
Write-Host
Write-Verbose "Creating New OSDCloud WinRE Template specific for ALL MSI MPG LGA 1851 motherboards to enable wireless networking support..." -Verbose
New-OSDCloudTemplate -Name MSI-MPG-LGA1851 -WinRE
