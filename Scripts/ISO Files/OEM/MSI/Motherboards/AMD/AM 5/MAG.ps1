...
Write-Host
Write-Verbose "Processing: MSI AMD MAG AM5 motherboard driver downloads" -Verbose
Write-Host 
...
Write-Host
Write-Verbose "Completed: MSI AMD MAG AM5 motherboard driver downloads" -Verbose
Write-Host 
