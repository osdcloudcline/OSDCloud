...
Write-Host
Write-Verbose "Processing: MSI AMD AM5 MEG motherboard driver downloads" -Verbose
Write-Host 
...
Write-Host
Write-Verbose "Completed: MSI AMD AM5 MEG motherboard driver downloads" -Verbose
Write-Host
