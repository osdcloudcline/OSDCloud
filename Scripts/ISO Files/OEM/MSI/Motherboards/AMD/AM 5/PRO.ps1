...
Write-Host
Write-Verbose "Creating New OSDCloud WinRE Template specific for ALL MSI PRO AM5 motherboards to enable wireless networking support..." -Verbose
New-OSDCloudTemplate -Name MSI-PRO-AM5 -WinRE
