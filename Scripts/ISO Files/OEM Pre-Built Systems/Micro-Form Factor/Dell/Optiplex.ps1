...
New-OSDCloudTemplate -Name OSDCloud-Dell-OptiplexMFF -WinRE
...
$WorkspacePath = "C:\OSDCloud\OEM Pre-Built\Dell\Micro-Form Factor\Optiplex"
...
Write-Verbose "Processing: Dell Optiplex Micro-Form Factor Ethernet Driver..." -Verbose
$EthernetDriver = ""

Edit-OSDCloudWinPE -DriverPath $EthernetDriver

Write-Host
Write-Verbose "Processing: Dell Optiplex Micro-Form Factor Bluetooth Driver..." -Verbose
$BluetoothDriver = ""

Edit-OSDCloudWinPE -DriverPath $BluetoothDriver

Write-Host
Write-Verbose "Processing: Dell Optiplex Micro-Form Factor WiFi Driver..." -Verbose
$WiFiDriver = ""

Edit-OSDCloudWinPE -DriverPath $WiFiDriver 

Write-Host
Write-Verbose "Processing: Dell Optiplex Micro-Form Factor Storage Driver..." -Verbose
$StorageDriver = ""

Edit-OSDCloudWinPE -DriverPath $StorageDriver 

Write-Host
Write-Verbose "Completed: Integration of Dell Optiplex Micro-Form Factor drivers into OSDCloud" -Verbose
Write-Host
