...
Write-Verbose "Creating New OSDCloud WinRE Template to enable wireless networking support for Intel Socket LGA 1700 systems..." -Verbose
New-OSDCloudTemplate -Name OSDCloud-LGA1700 -WinRE
