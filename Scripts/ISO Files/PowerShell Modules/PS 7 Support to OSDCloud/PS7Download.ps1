...
# File Paths
$PS7Source = "https://github.com/PowerShell/PowerShell/releases/download/v7.6.1/PowerShell-7.6.1-win-x64.zip"
...
Write-Host
Write-Verbose "Completed: PowerShell 7, Version 7.6.1 64-bit has downloaded" -Verbose
Write-Host
