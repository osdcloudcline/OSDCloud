...
Write-Host '     - Networking and Storage: Dell Inspiron 7720SE                                           ' -ForegroundColor DarkBlue -BackgroundColor White
...
Write-Host
Write-Verbose "Processing: DELL Inspiron 17R 7720SE driver downloads" -Verbose
Write-Host 

$Indspiron17R7720SE = Invoke-WebRequest("")
Invoke-Expression $($Indspiron17R7720SE.Content)

Write-Host
Write-Verbose "Completed: DELL Inspiron 17R 7720SE driver downloads" -Verbose
Write-Host
