...
$sourceWIM = "$WindowsImage\sources"
...
Export-WindowsImage -SourceImagePath "sourceWIM\install.wim" -SourceIndex $Index -DestinationImagePath "$Destination\$ExportWIMFileName" -DestinationName "Windows 11 Pro - Sean PC" 
