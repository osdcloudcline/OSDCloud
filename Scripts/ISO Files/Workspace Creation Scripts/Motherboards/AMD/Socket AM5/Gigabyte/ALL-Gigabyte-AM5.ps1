...
Write-Host
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ALL-Gigabyte-AM5\OSDCloud-ALL-Gigabyte-AM5.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ALL-Gigabyte-AM5\OSDCloud-ALL-Gigabyte-AM5_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "C:\OSDCloud\ALL-Gigabyte-AM5\OSDCloud-ALL-Gigabyte-AM5.iso"
$ISO2 = "C:\OSDCloud\ALL-Gigabyte-AM5\OSDCloud-ALL-Gigabyte-AM5_NoPrompt.iso"
