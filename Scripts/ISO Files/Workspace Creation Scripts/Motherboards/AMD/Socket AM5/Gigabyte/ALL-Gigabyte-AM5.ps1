...
New-OSDCloudTemplate -Name ALL-Gigabyte-AM5 -WinRE
...
$WorkspacePath = "C:\OSDCloud\ALL-Gigabyte-AM5"
...
$OSDCloudISOPath = "C:\OSDCloud\ALL-Gigabyte-AM5"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Write-Host
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ALL-Gigabyte-AM5\OSDCloud-Version 1.0-ALL-Gigabyte-AM5.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ALL-Gigabyte-AM5\OSDCloud-Version 1.0-ALL-Gigabyte-AM5_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "C:\OSDCloud\ALL-Gigabyte-AM5\OSDCloud-Version 1.0-ALL-Gigabyte-AM5.iso"
$ISO2 = "C:\OSDCloud\ALL-Gigabyte-AM5\OSDCloud-Version 1.0-ALL-Gigabyte-AM5_NoPrompt.iso"
