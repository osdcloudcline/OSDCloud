...
Write-Host
Write-Verbose "Creating New OSDCloud WinRE Template specific for ALL Gigabyte Gaming AM5 motherboards to enable wireless networking support..." -Verbose
...
$WorkspacePath = "C:\OSDCloud\Gigabyte-Gaming-AM5"
...
$OSDCloudISOPath = "C:\OSDCloud\Gigabyte-Gaming-AM5"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Write-Host
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\Gigabyte-Gaming-AM5\OSDCloud-Version 1.0-Gigabyte-Gaming-AM5.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\Gigabyte-Gaming-AM5\OSDCloud-Version 1.0-Gigabyte-Gaming-AM5_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "C:\OSDCloud\Gigabyte-Gaming-AM5\OSDCloud-Version 1.0-Gigabyte-Gaming-AM5.iso"
$ISO2 = "C:\OSDCloud\Gigabyte-Gaming-AM5\OSDCloud-Version 1.0-Gigabyte-Gaming-AM5_NoPrompt.iso"
