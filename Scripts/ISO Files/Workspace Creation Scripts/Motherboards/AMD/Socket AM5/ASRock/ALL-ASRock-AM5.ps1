...
Write-Host
Write-Verbose "Creating New OSDCloud WinRE Template specific for ALL ASRock AM5 motherboards to enable wireless networking support..." -Verbose
New-OSDCloudTemplate -Name ALL-ASRock-AM5 -WinRE
...
Write-Host
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ALL-ASRock-AM5\OSDCloud-Version 1.0-ALL-ASRock-AM5.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ALL-ASRock-AM5\OSDCloud-Version 1.0-ALL-ASRock-AM5_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "C:\OSDCloud\ALL-ASRock-AM5\OSDCloud-Version 1.0-ALL-ASRock-AM5.iso"
$ISO2 = "C:\OSDCloud\ALL-ASRock-AM5\OSDCloud-Version 1.0-ALL-ASRock-AM5_NoPrompt.iso"
