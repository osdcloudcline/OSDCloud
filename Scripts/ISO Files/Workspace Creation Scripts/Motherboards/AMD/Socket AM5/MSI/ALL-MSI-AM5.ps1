...
New-OSDCloudTemplate -Name ALL-MSI-AM5 -WinRE
...
$WorkspacePath = "C:\OSDCloud\ALL-MSI-AM5"
...
$OSDCloudISOPath = "C:\OSDCloud\ALL-MSI-AM5"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Write-Host
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ALL-MSI-AM5\OSDCloud-Version 1.0-ALL-MSI-AM5.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ALL-MSI-AM5\OSDCloud-Version 1.0-ALL-MSI-AM5_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "C:\OSDCloud\ALL-MSI-AM5\OSDCloud-Version 1.0-ALL-MSI-AM5.iso"
$ISO2 = "C:\OSDCloud\ALL-MSI-AM5\OSDCloud-Version 1.0-ALL-MSI-AM5_NoPrompt.iso"
