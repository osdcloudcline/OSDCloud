...
Write-Host
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ALL-MSI-AM5\OSDCloud-ALL-MSI-AM5.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ALL-MSI-AM5\OSDCloud-ALL-MSI-AM5_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "C:\OSDCloud\ALL-MSI-AM5\OSDCloud-ALL-MSI-AM5.iso"
$ISO2 = "C:\OSDCloud\ALL-MSI-AM5\OSDCloud-ALL-MSI-AM5_NoPrompt.iso"
