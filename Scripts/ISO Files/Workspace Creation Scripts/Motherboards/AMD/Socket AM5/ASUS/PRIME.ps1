...
Write-Host
Write-Verbose "Creating New OSDCloud WinRE Template specific for ASUS PRIME AM5 motherboards to enable wireless networking support..." -Verbose
...
$WorkspacePath = "C:\OSDCloud\ASUS-PRIME-AM5"
...
$OSDCloudISOPath = "C:\OSDCloud\ASUS-PRIME-AM5"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Write-Host
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ASUS-PRIME-AM5\OSDCloud-Version 1.0-ASUS-PRIME-AM5.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ASUS-PRIME-AM5\OSDCloud-Version 1.0-ASUS-PRIME-AM5_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "C:\OSDCloud\ASUS-PRIME-AM5\OSDCloud-Version 1.0-ASUS-PRIME-AM5.iso"
$ISO2 = "C:\OSDCloud\ASUS-PRIME-AM5\OSDCloud-Version 1.0-ASUS-PRIME-AM5_NoPrompt.iso"
