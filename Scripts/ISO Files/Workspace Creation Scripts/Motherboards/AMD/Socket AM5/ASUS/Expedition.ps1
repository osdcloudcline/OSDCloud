...
Write-Host
Write-Verbose "Creating New OSDCloud WinRE Template specific for ASUS Expedition AM5 motherboards to enable wireless networking support..." -Verbose
New-OSDCloudTemplate -Name ASUS-Expedition-AM5 -WinRE
...
$WorkspacePath = "C:\OSDCloud\ASUS-Expedition-AM5"
...
$OSDCloudISOPath = "C:\OSDCloud\ASUS-Expedition-AM5"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Write-Host
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ASUS-Expedition-AM5\OSDCloud-Version 1.0-ASUS-Expedition-AM5.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ASUS-Expedition-AM5\OSDCloud-Version 1.0-ASUS-Expedition-AM5_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "C:\OSDCloud\ASUS-Expedition-AM5\OSDCloud-Version 1.0-ASUS-Expedition-AM5.iso"
$ISO2 = "C:\OSDCloud\ASUS-Expedition-AM5\OSDCloud-Version 1.0-ASUS-Expedition-AM5_NoPrompt.iso"

$OSDISODestination = "C:\ISOs\OSDCloud\AMD\Socket AM5\ASUS"
