...
$WorkspacePath = "C:\OSDCloud\ASRock-Taichi-AM4"
...
$OSDCloudISOPath = "C:\OSDCloud\ASRock-Taichi-AM4"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "$OSDCloudISOPath\OSDCloud-Version 1.0-ASRock-Taichi-AM4.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "$OSDCloudISOPath\OSDCloud-Version 1.0-ASRock-Taichi-AM4_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "$OSDCloudISOPath\OSDCloud-Version 1.0-ASRock-Taichi-AM4.iso"
$ISO2 = "$OSDCloudISOPath\OSDCloud-Version 1.0-ASRock-Taichi-AM4_NoPrompt.iso"
