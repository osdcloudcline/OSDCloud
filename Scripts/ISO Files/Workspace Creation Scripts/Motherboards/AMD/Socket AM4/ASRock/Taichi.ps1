...
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "$OSDCloudISOPath\OSDCloud-ASRock-Taichi-AM4.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "$OSDCloudISOPath\OSDCloud-ASRock-Taichi-AM4_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "$OSDCloudISOPath\OSDCloud-ASRock-Taichi-AM4.iso"
$ISO2 = "$OSDCloudISOPath\OSDCloud-ASRock-Taichi-AM4_NoPrompt.iso"
