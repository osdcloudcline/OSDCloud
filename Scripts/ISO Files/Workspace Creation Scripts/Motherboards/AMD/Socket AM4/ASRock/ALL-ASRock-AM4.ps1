...
Write-Host
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ALL-ASRock-AM4\OSDCloud-Version 1.0-ALL-ASRock-AM4.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ALL-ASRock-AM4\OSDCloud-Version 1.0-ALL-ASRock-AM4_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "C:\OSDCloud\ALL-ASRock-AM4\OSDCloud-Version 1.0-ALL-ASRock-AM4.iso"
$ISO2 = "C:\OSDCloud\ALL-ASRock-AM4\OSDCloud-Version 1.0-ALL-ASRock-AM4_NoPrompt.iso"
