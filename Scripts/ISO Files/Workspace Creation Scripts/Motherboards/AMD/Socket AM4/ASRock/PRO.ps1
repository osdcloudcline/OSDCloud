...
Write-Host
Write-Verbose "Creating New OSDCloud WinRE Template specific for ASRock AM4 PRO motherboards to enable wireless networking support..." -Verbose
New-OSDCloudTemplate -Name ASRock-PRO-AM4 -WinRE
...
Write-Host
Write-Verbose "Processing: ASRock PRO Socket AM4 Motherboard drivers download......" -Verbose
Write-Host
...
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ASRock-PRO-AM4\OSDCloud-Version 1.0-ASRock-PRO-AM4.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ASRock-PRO-AM4\OSDCloud-Version 1.0-ASRock-PRO-AM4_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "C:\OSDCloud\ASRock-PRO-AM4\OSDCloud-Version 1.0-ASRock-PRO-AM4.iso"
$ISO2 = "C:\OSDCloud\ASRock-PRO-AM4\OSDCloud-Version 1.0-ASRock-PRO-AM4_NoPrompt.iso"
