...
Write-Host
Write-Verbose "Creating New OSDCloud WinRE Template specific for ALL Gigabyte AORUS AM4 motherboards to enable wireless networking support..." -Verbose
...
$WorkspacePath = "C:\OSDCloud\Gigabyte-AORUS-AM4"
...
$AORUSDrivers = Invoke-WebRequest("")
...
$OSDCloudISOPath = "C:\OSDCloud\Gigabyte-AORUS-AM4"
