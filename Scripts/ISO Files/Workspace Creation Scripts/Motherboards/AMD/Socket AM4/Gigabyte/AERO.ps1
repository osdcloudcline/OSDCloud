...
Invoke-Expression $($AERDrivers.Content)
...
Write-Host
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\Gigabyte-AERO-AM4\OSDCloud-Gigabyte-AERO-AM4.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\Gigabyte-AERO-AM4\OSDCloud-Gigabyte-AERO-AM4_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "C:\OSDCloud\Gigabyte-AERO-AM4\OSDCloud-Gigabyte-AERO-AM4.iso"
$ISO2 = "C:\OSDCloud\Gigabyte-AERO-AM4\OSDCloud-Gigabyte-AERO-AM4_NoPrompt.iso"
