...
Write-Host
Write-Verbose "Creating New OSDCloud WinRE Template specific for ALL Gigabyte AERO AM4 motherboards to enable wireless networking support..." -Verbose
...
$WorkspacePath = "C:\OSDCloud\Gigabyte-AERO-AM4"
...
$OSDCloudISOPath = "C:\OSDCloud\Gigabyte-AERO-AM4"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Write-Host
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\Gigabyte-AERO-AM4\OSDCloud-Version 1.0-Gigabyte-AERO-AM4.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\Gigabyte-AERO-AM4\OSDCloud-Version 1.0-Gigabyte-AERO-AM4_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "C:\OSDCloud\Gigabyte-AERO-AM4\OSDCloud-Version 1.0-Gigabyte-AERO-AM4.iso"
$ISO2 = "C:\OSDCloud\Gigabyte-AERO-AM4\OSDCloud-Version 1.0-Gigabyte-AERO-AM4_NoPrompt.iso"
