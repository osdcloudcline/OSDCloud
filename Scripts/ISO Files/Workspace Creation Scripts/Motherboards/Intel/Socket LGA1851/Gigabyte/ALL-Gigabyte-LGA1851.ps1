...
New-OSDCloudTemplate -Name ALL-Gigabyte-LGA1851 -WinRE
...
$WorkspacePath = "C:\OSDCloud\ALL-Gigabyte-LGA1851"
...
$OSDCloudISOPath = "C:\OSDCloud\ALL-Gigabyte-LGA1851"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Write-Host
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ALL-Gigabyte-LGA1851\OSDCloud-ALL-Gigabyte-LGA1851.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ALL-Gigabyte-LGA1851\OSDCloud-ALL-Gigabyte-LGA1851_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "C:\OSDCloud\ALL-Gigabyte-LGA1851\OSDCloud-ALL-Gigabyte-LGA1851.iso"
$ISO2 = "C:\OSDCloud\ALL-Gigabyte-LGA1851\OSDCloud-ALL-Gigabyte-LGA1851_NoPrompt.iso"
