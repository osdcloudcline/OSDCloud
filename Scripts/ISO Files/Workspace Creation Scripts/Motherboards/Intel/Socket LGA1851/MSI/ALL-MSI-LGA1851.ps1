...
New-OSDCloudTemplate -Name ALL-MSI-LGA1851 -WinRE
...
$WorkspacePath = "C:\OSDCloud\ALL-MSI-LGA1851"
...
$OSDCloudISOPath = "C:\OSDCloud\ALL-MSI-LGA1851"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Write-Host
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ALL-MSI-LGA1851\OSDCloud-ALL-MSI-LGA1851.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ALL-MSI-LGA1851\OSDCloud-ALL-MSI-LGA1851_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "C:\OSDCloud\ALL-MSI-LGA1851\OSDCloud-ALL-MSI-LGA1851.iso"
$ISO2 = "C:\OSDCloud\ALL-MSI-LGA1851\OSDCloud-ALL-MSI-LGA1851_NoPrompt.iso"
