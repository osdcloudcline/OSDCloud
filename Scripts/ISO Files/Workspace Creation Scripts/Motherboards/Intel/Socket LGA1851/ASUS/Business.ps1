...
$WorkspacePath = "C:\OSDCloud\ASUS-Business-LGA1851"
...
$BusinessdDrivers = Invoke-WebRequest("https://github.com/osdcloudcline/OSDCloudDrivers/raw/refs/heads/main/Network%20and%20Storage%20/ASUS/Desktops/Intel/LGA%201851/Business%20Motherbords/Business.ps1")
Invoke-Expression $($BusinessdDrivers.Content)
...
$OSDCloudISOPath = "C:\OSDCloud\ASUS-Business-LGA1851"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Write-Host
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ASUS-Business-LGA1851\OSDCloud-ASUS-Business-LGA1851.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ASUS-Business-LGA1851\OSDCloud-ASUS-Business-LGA1851_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "C:\OSDCloud\ASUS-Business-LGA1851\OSDCloud-ASUS-Business-LGA1851.iso"
$ISO2 = "C:\OSDCloud\ASUS-Business-LGA1851\OSDCloud-ASUS-Business-LGA1851_NoPrompt.iso"

$OSDISODestination = "C:\ISOs\OSDCloud\Intel\Socket LGA1851\ASUS"
