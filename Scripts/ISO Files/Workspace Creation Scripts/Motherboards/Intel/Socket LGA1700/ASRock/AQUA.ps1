...
New-OSDCloudTemplate -Name ASRock-AQUA-LGA1700 -WinRE
...
$WorkspacePath = "C:\OSDCloud\ASRock-AQUA-LGA1700"
...
$OSDCloudISOPath = "C:\OSDCloud\ASRock-AQUA-LGA1700"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Write-Host
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ASRock-AQUA-LGA1700\OSDCloud-ASRock-AQUA-LGA1700.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ASRock-AQUA-LGA1700\OSDCloud-ASRock-AQUA-LGA1700_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "C:\OSDCloud\ASRock-AQUA-LGA1700\OSDCloud-ASRock-AQUA-LGA1700.iso"
$ISO2 = "C:\OSDCloud\ASRock-AQUA-LGA1700\OSDCloud-ASRock-AQUA-LGA1700_NoPrompt.iso"
