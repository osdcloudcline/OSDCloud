...
New-OSDCloudTemplate -Name ALL-Gigabyte-LGA1700 -WinRE
...
$WorkspacePath = "C:\OSDCloud\ALL-Gigabyte-LGA1700"
...
$OSDCloudISOPath = "C:\OSDCloud\ALL-Gigabyte-LGA1700"

Write-Verbose "Renaming OSDCloud ISO Files..." -Verbose
Write-Host
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\ALL-Gigabyte-LGA1700\OSDCloud-ALL-Gigabyte-LGA1700.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\ALL-Gigabyte-LGA1700\OSDCloud-ALL-Gigabyte-LGA1700_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "C:\OSDCloud\ALL-Gigabyte-LGA1700\OSDCloud-ALL-Gigabyte-LGA1700.iso"
$ISO2 = "C:\OSDCloud\ALL-Gigabyte-LGA1700\OSDCloud-ALL-Gigabyte-LGA1700_NoPrompt.iso"

$OSDISODestination = "C:\ISOs\OSDCloud\Intel\Socket LGA1700\Gigabyte"
