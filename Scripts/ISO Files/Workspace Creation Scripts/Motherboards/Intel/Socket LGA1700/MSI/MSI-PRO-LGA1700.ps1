...
Write-Host
Rename-Item -Path "$OSDCloudISOPath\OSDCloud.iso" -NewName "C:\OSDCloud\MSI-PRO-LGA1700\OSDCloud-MSI-PRO-LGA1700.iso" -Force
Rename-Item -Path "$OSDCloudISOPath\OSDCloud_NoPrompt.iso" -NewName "C:\OSDCloud\MSI-PRO-LGA1700\OSDCloud-MSI-PRO-LGA1700_NoPrompt.iso" -Force

###########################################
# Copy OSDCloud ISO Files
#########################################

$ISO1 = "C:\OSDCloud\MSI-PRO-LGA1700\OSDCloud-MSI-PRO-LGA1700.iso"
$ISO2 = "C:\OSDCloud\MSI-PRO-LGA1700\OSDCloud-MSI-PRO-LGA1700_NoPrompt.iso"
