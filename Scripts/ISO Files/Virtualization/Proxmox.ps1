...
Write-Host '     - Networking and Storage: VM drivers for Proxmox                                        ' -ForegroundColor DarkBlue -BackgroundColor White
...
Write-Host
Write-Verbose "Completed: Proxmox Virtualization driver downloads" -Verbose
Write-Host
...
New-OSDCloudTemplate -Name Proxmox-Virtual -WinRE
