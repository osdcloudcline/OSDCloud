...
Write-Host '     - Networking and Storage: VM drivers for ESXI                                            ' -ForegroundColor DarkBlue -BackgroundColor White
...
Write-Host
Write-Verbose "Completed: ESXI Virtualization driver downloads" -Verbose
Write-Host
