...
Write-Host '     - Networking and Storage: VM drivers for Hyper-V                                         ' -ForegroundColor DarkBlue -BackgroundColor White
...
Write-Host
Write-Verbose "Completed: Microsoft Hyper-V Virtualization driver downloads" -Verbose
Write-Host
...
New-OSDCloudTemplate -Name HyperV-Virtual -WinRE
