...
Write-Host '     - Networking and Storage: VM drivers for VMWare Workstation Pro                          ' -ForegroundColor DarkBlue -BackgroundColor White
...
Write-Host
Write-Verbose "Completed: VMWare Workstation Pro Virtualization driver downloads" -Verbose
Write-Host
...
New-OSDCloudTemplate -Name VMWareWorkstationPro-Virtual -WinRE
...
$WorkspacePath = "C:\OSDCloud\VMWare-WorkstationPro"
